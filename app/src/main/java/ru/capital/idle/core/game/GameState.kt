...
data class GameState(
    ...
    // игровой день, на который снята показываемая прибыль предприятий (Enterprise.profitShown).
    // Отметка своя, а не общая с давлением: у старых сохранений правила восстановления разные
