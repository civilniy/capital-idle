...
object Onboarding {
    ...
    fun lockText(id: String): Pair<String, String> = when (id) {
        ...
        "world" -> "Мир" to "Наберите капитал в $ 1 000 000 — узнаете своё место среди богатейших."
        "prof" -> "Профиль" to "Устройтесь на работу — появится ваш профиль и имущество."
        "net" -> "Окружение" to "Наберите капитал в $ 5 000 — полезные знакомства найдут вас сами."
        "pres" -> "Престиж" to "Наберите капитал в $ 1 000 000 000 — откроется перерождение."
        else -> "" to ""
    }
